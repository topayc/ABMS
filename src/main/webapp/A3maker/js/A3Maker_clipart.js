...
$(function () {
    A3Maker.clipArt = {
		...
		show : function(){
			...
			var context = this;
            this.$clipArtConainer = $(A3Maker.clipArtHTML);
			...
			A3Maker.api.A3MakerApi('loadCode', { code_d1: clipArt_cate1_code_d1, code_d2: clipArt_cate1_code_d2, code_d3: clipArt_cate1_code_d3 }, function (clipCate1Result) {
                ...
                /* load clipart category1*/
                A3Maker.api.A3MakerApi('loadCode', { code_d1: clipArt_cate2_code_d1, code_d2: clipArt_cate2_code_d2, code_d3: clipArt_cate2_code_d3 }, function (clipCate2Result) {
		...
		loadClipArts : function(code) {
			...
			var context = this;
			 A3Maker.api.A3MakerApi('loadClipArts', param, function (result) {
            	console.log(result);
