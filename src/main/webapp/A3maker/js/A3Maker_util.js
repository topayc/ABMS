...
A3Maker.util = {
    ...
    array: {
        movePageToFirst: function (pageArr,sPage) {
            ...
            var addArrElim = A3Maker.project.pages[sIndex];
            A3Maker.project.pages.splice(sIndex, 1).unshift(addArrElim);
        },
        ...
        movePageToLast: function (pageArr, sPage) {
            ...
            var addArrElim = A3Maker.project.pages[sIndex];
            A3Maker.project.pages.splice(sIndex, 1).push(addArrElim);
        },
        ...
        movePageBefore: function (pages, sPage, tPage) {
            ...
            A3Maker.project.pages.splice(tIndex, 1);
            $.each(pages,function (index, page) {
                if (page.UUID == sPage.UUID) {
                    sIndex = index;
                }
            });
            A3Maker.project.pages.splice(sIndex - 1, 0, tPage);
        },
        ...
        movePageAfter: function (pages, target_page, moved_page) {
            ...
            A3Maker.project.pages.splice(moved_page_inx, 1);
            ...
            A3Maker.project.pages.splice(target_page_inx, 0, moved_page);
        }
    }
};
