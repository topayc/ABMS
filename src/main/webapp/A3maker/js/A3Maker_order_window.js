    ...
    A3Maker.orderWindow = {
       ...
       loadMenuGroupInfo : function(){
    		...
    		this.$productListContainer.empty();
	       	...
	       	A3Maker.api.A3MakerApi('loadProductGroup',{}, function(result){
	    	...
	    	$.each(groupList, function(index, group){
	    		...
	    		$groupItem.click(function(event){
	    			...
	    			A3Maker.api.A3MakerApi('loadProductByProductGroup', { group_code : $(this).attr('group_code')}, function(result){
	    				if (result.resultCode !=0){
       ...
       show : function(){
    		...
    		this.$orderWindow = $(A3Maker.orderWindowHTML);
    		...
    		this.$addMenu.click(function(event){
    			context.$addMenuContainer = $(A3Maker.addMenuContainerHTML);
    		...
    		this.$orderWindow.find('.choose').click(function(event){
    			if (context.selectedProductGroupCode == -1 || context.selectedProductCode == -1){
    				...
    				if (selectedComponent.data.type != 'order' ){
