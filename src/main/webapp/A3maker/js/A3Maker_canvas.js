...
$(function () {
    A3Maker.canvas = {
        ...
        initCanvas: function () {
            ...
            $(A3Maker.holder).css('left', '17px');
            $(A3Maker.holder).css('top', '17px');
        },
        ...
        findZooomOnWindowSize : function(){
            ...
            var resolutionHeight = A3Maker.project.height;
            var properZoom = 100;
            var propertHeight = 0;
            ...
            this.canvasWidth = A3Maker.project.width * (this.zoom / 100);
            this.canvasHeight= A3Maker.project.height* (this.zoom / 100);
        ...
        adjustCanvas: function () {
            ...
            //console.log("실제 넓이",$(A3Maker.holder).css('width'));
            //console.log("실제 높이",$(A3Maker.holder).css('height'));
            ...
            $(A3Maker.holder).css({ transform: 'scale(' + scale + ',' + scale + ' )' });
        },
